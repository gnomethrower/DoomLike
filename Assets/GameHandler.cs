...
public class GameHandler : MonoBehaviour
{
    ...
    public static Action OnActivateDebugMode;

    public void Awake()
    {
        #region Player Death
        PlayerController_Script.Action_PlayerDeath += HandlePlayerDeath;
        OnActivateDebugMode += OnDebugModeSetActive;
